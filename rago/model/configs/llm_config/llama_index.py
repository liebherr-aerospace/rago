"""Define the LlamaIndex llm config."""
...
@dataclass
class LLamaIndexLLMConfig(LLMConfig):
...
@dataclass
class LlamaIndexOllamaConfig(LLamaIndexLLMConfig):
    """Configuration parameters of the Ollama LLM."""

    model_name: str = Field(default="phi3:3.8b-mini-128k-instruct-q8_0")
