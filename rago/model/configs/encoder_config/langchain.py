"""Define the langchain encoder config."""
...
@dataclass
class LangchainEncoderConfig(Config):
...
@dataclass
class OllamaLangchainEncoderConfig(LangchainEncoderConfig):
...
@dataclass
class HuggingFaceLangchainEncoderConfig(LangchainEncoderConfig):
